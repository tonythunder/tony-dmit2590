...
$j(document).ready(function() {
	...
	var formfield;
	$j(document).on('click', '.brand_image,.slide_image,.parallax_image,.portfolioimg,.logo_image,.favicon_image,.background_image,.pattern_background_image,.title_image,.google_maps_pin_image,.facebook_icon,.twitter_icon,.google_plus_icon', function(event) {
