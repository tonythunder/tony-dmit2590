						...
						<div class="form-field form-required">
							...
							switch ( $customField[ 'type' ] ) {
								...
								case "selectbox-animation": {
									$page_transitions = "2";
									if (isset($qode_options_flat['page_transitions'])) $page_transitions = $qode_options_flat['page_transitions'];
		...
		*/
		function displayCustomSeo() {
			...
			<div class="input form-field">
					...
					?>
				<label for="seo_title"><b>SEO 标题</b></label>
			...
			<div class="input form-field">
					...
					?>
				<label for="seo_keywords"><b>SEO 关键词</b></label>
			...
			<div class="input form-field">
					...
					?>
				<label for="seo_description"><b>SEO 描述</b></label>
...
<a class="remove_parallax" href="/" onclick="javascript: return false;">删除视差部分</a>
</div>
</div>
...
?>
				<a class="add_parallax" onclick="javascript: return false;" href="/" >添加视差部分</a>
			</div>
		</div>
			<?php
		}
...
<div class="input form-field">
<label for="portfolioimgordernumber_<?php echo $no; ?>"><b>排序编号</b></label>
...
<div class="input form-field">
<label for="portfoliotitle_<?php echo $no; ?>"><b>图像/视频标题 (only for gallery layout - Portfolio Style 6)</b></label>
...
<div class="input form-field">
<label for="portfolioimg_<?php echo $no; ?>"><b>图像</b></label>
...
<div class="input form-field">
	<label for="portfoliovideotype_<?php echo $no; ?>"><b>视频类型</b></label>
...
<div class="input form-field">
<label for="portfoliovideoid_<?php echo $no; ?>"><b>视频 ID</b></label>
...
<a class="remove_image" href="/" onclick="javascript: return false;">删除作品图像/视频</a>
</div>
...
?>
				<a class="add_image" onclick="javascript: return false;" href="/" >添加作品图像/视频</a>
</div>
</div>
...
<div class="input form-field">
<label for="optionlabelordernumber_<?php echo $no; ?>"><b>排序编码</b></label>
...
<div class="input form-field">
<label for="optionUrl_<?php echo $no; ?>"><b>选项 Url</b></label>
<input id="optionUrl_<?php echo $no; ?>" type="text" name="optionUrl[]" value="<?php echo stripslashes($portfolio['optionUrl']); ?>">
</div>

<a class="remove_option" href="/" onclick="javascript: return false;">删除作品选项</a>
</div>
...
?>
				<a class="add_option" onclick="javascript: return false;" href="/" >添加作品选项</a>
</div>
</div>
			<div class="input form-field">
<?php
