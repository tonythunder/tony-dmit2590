	...
	<div class="post" id="post-<?php the_ID(); ?>">
		...
		<div class="entry">
			<div class="postmetadata">
				Author: <?php the_author_posts_link(); ?> Date of Post: <span><?php the_time('Y/M/D'); ?></span> Classification: <?php the_category(', ') ?> 
                <?php the_tags('Label: ', ' , ' , ''); ?> 
				Reviews: <?php comments_popup_link('0', '1', '%'); ?> Article <?php edit_post_link('[Edit]'); ?>
			</div>
            ...
            <div class="readmore">
            	<span><?php if(function_exists('the_views')) { echo"Reviews: "; the_views(); } ?></span>
