        ...
        <div id="header">
            <div id="nav">
                ...
                <form method="get" class="search-form" action="/" >
                    <input class="col-5 col-m-5 search-input" name="s" type="text" placeholder="Enter search keywords" autofocus="" x-webkit-speech="">
                        <input class="col-5 col-m-5 search-submit" type="submit" value="Search">
                            </form>
